...
if ( ! function_exists( 'boxstyle_load' ) ) {
	
	function boxstyle_load() {
		// Load theme languages
		load_theme_textdomain( 'boxstyle', get_template_directory().'/languages' );
...
add_action( 'after_setup_theme', 'boxstyle_load' );	
...
/*  Theme setup
/* ------------------------------------ */
if ( ! function_exists( 'boxstyle_setup' ) ) {
	
	function boxstyle_setup() {
		// Enable title tag
		...
		add_image_size( 'boxstyle-list', 320, 320, true );
...
add_action( 'after_setup_theme', 'boxstyle_custom_logo' );


/*  Custom header
/* ------------------------------------ */
if ( ! function_exists( 'boxstyle_custom_header' ) ) {
	
	function boxstyle_custom_header() {
		$args = array(
			'default-image'	=> false,
			'default-text'	=> false,
			'width'			=> 1120,
...
add_action( 'after_setup_theme', 'boxstyle_custom_header' );


/*  Custom background
/* ------------------------------------ */
if ( ! function_exists( 'boxstyle_custom_background' ) ) {
	
	function boxstyle_custom_background() {
		$args = array();
		add_theme_support( 'custom-background', $args );
	}
	
}
add_action( 'after_setup_theme', 'boxstyle_custom_background' );


/*  Deregister
/* ------------------------------------ */
if ( ! function_exists( 'boxstyle_deregister' ) ) {
	
	function boxstyle_deregister() {
		wp_deregister_style( 'wp-pagenavi' );
	}
	
}
add_action( 'wp_enqueue_scripts', 'boxstyle_deregister', 100 );


/*  Register sidebars
/* ------------------------------------ */	
if ( ! function_exists( 'boxstyle_sidebars' ) ) {

	function boxstyle_sidebars()	{
		register_sidebar(array( 'name' => esc_html__('Primary','boxstyle'),'id' => 'primary','description' => esc_html__("Normal full width sidebar","boxstyle"), 'before_widget' => '<div id="%1$s" class="widget %2$s">','after_widget' => '</div>','before_title' => '<h3 class="group"><span>','after_title' => '</span></h3>'));
		
		if ( get_theme_mod('footer-ads') == 'on' ) { register_sidebar(array( 'name' => esc_html__('Footer Ads',"boxstyle"),'id' => 'footer-ads', 'description' => esc_html__("Footer ads area","boxstyle"), 'before_widget' => '<div id="%1$s" class="widget %2$s">','after_widget' => '</div>','before_title' => '<h3 class="group"><span>','after_title' => '</span></h3>')); }
		
		if ( get_theme_mod('frontpage-widgets-top') == 'on' ) { register_sidebar(array( 'name' => esc_html__('Frontpage Top 1','boxstyle'),'id' => 'frontpage-top-1', 'description' => esc_html__("Frontpage area","boxstyle"), 'before_widget' => '<div id="%1$s" class="widget %2$s">','after_widget' => '</div>','before_title' => '<h3 class="group"><span>','after_title' => '</span></h3>')); }
		if ( get_theme_mod('frontpage-widgets-top') == 'on' ) { register_sidebar(array( 'name' => esc_html__('Frontpage Top 2','boxstyle'),'id' => 'frontpage-top-2', 'description' => esc_html__("Frontpage area","boxstyle"), 'before_widget' => '<div id="%1$s" class="widget %2$s">','after_widget' => '</div>','before_title' => '<h3 class="group"><span>','after_title' => '</span></h3>')); }
		if ( get_theme_mod('frontpage-widgets-bottom') == 'on' ) { register_sidebar(array( 'name' => esc_html__('Frontpage Bottom 1','boxstyle'),'id' => 'frontpage-bottom-1', 'description' => esc_html__("Frontpage area","boxstyle"), 'before_widget' => '<div id="%1$s" class="widget %2$s">','after_widget' => '</div>','before_title' => '<h3 class="group"><span>','after_title' => '</span></h3>')); }
		if ( get_theme_mod('frontpage-widgets-bottom') == 'on' ) { register_sidebar(array( 'name' => esc_html__('Frontpage Bottom 2','boxstyle'),'id' => 'frontpage-bottom-2', 'description' => esc_html__("Frontpage area","boxstyle"), 'before_widget' => '<div id="%1$s" class="widget %2$s">','after_widget' => '</div>','before_title' => '<h3 class="group"><span>','after_title' => '</span></h3>')); }
		
		if ( get_theme_mod('footer-widgets') >= '1' ) { register_sidebar(array( 'name' => esc_html__('Footer 1','boxstyle'),'id' => 'footer-1', 'description' => esc_html__("Widgetized footer","boxstyle"), 'before_widget' => '<div id="%1$s" class="widget %2$s">','after_widget' => '</div>','before_title' => '<h3 class="group"><span>','after_title' => '</span></h3>')); }
		if ( get_theme_mod('footer-widgets') >= '2' ) { register_sidebar(array( 'name' => esc_html__('Footer 2','boxstyle'),'id' => 'footer-2', 'description' => esc_html__("Widgetized footer","boxstyle"), 'before_widget' => '<div id="%1$s" class="widget %2$s">','after_widget' => '</div>','before_title' => '<h3 class="group"><span>','after_title' => '</span></h3>')); }
		if ( get_theme_mod('footer-widgets') >= '3' ) { register_sidebar(array( 'name' => esc_html__('Footer 3','boxstyle'),'id' => 'footer-3', 'description' => esc_html__("Widgetized footer","boxstyle"), 'before_widget' => '<div id="%1$s" class="widget %2$s">','after_widget' => '</div>','before_title' => '<h3 class="group"><span>','after_title' => '</span></h3>')); }
		if ( get_theme_mod('footer-widgets') >= '4' ) { register_sidebar(array( 'name' => esc_html__('Footer 4','boxstyle'),'id' => 'footer-4', 'description' => esc_html__("Widgetized footer","boxstyle"), 'before_widget' => '<div id="%1$s" class="widget %2$s">','after_widget' => '</div>','before_title' => '<h3 class="group"><span>','after_title' => '</span></h3>')); }
	}
	
}
add_action( 'widgets_init', 'boxstyle_sidebars' );


/*  Enqueue javascript
/* ------------------------------------ */	
if ( ! function_exists( 'boxstyle_scripts' ) ) {
...
add_action( 'wp_enqueue_scripts', 'boxstyle_scripts' ); 


/*  Enqueue css
/* ------------------------------------ */	
if ( ! function_exists( 'boxstyle_styles' ) ) {
...
/*  Layout class
/* ------------------------------------ */
if ( ! function_exists( 'boxstyle_layout_class' ) ) {
	
	function boxstyle_layout_class() {
		// Default layout
		$layout = 'col-2cr';
		$default = 'col-2cr';
...
/* ------------------------------------ */
if ( ! function_exists( 'boxstyle_sidebar_primary' ) ) {
	
	function boxstyle_sidebar_primary() {
		// Default sidebar
		$sidebar = 'primary';
...
/* ------------------------------------ */
if ( ! function_exists( 'boxstyle_sidebar_secondary' ) ) {

	function boxstyle_sidebar_secondary() {
		// Default sidebar
		$sidebar = 'secondary';
...
/*  Social links
/* ------------------------------------ */
if ( ! function_exists( 'boxstyle_social_links' ) ) {

	function boxstyle_social_links() {
...
/*  Site name/logo
/* ------------------------------------ */
if ( ! function_exists( 'boxstyle_site_title' ) ) {

	function boxstyle_site_title() {
...
/*  Blog title
/* ------------------------------------ */
if ( ! function_exists( 'boxstyle_blog_title' ) ) {

	function boxstyle_blog_title() {
		global $post;
...
/*  Related posts
/* ------------------------------------ */
if ( ! function_exists( 'boxstyle_related_posts' ) ) {

	function boxstyle_related_posts() {
		wp_reset_postdata();
		global $post;
...
if ( ! function_exists( 'boxstyle_post_images' ) ) {
	...
	function boxstyle_post_images( $args=array() ) {
		global $post;
...
/*  Excerpt ending
/* ------------------------------------ */
if ( ! function_exists( 'boxstyle_excerpt_more' ) ) {

	function boxstyle_excerpt_more( $more ) {
		if ( is_admin() ) {
			return $more;
		}
		return '&#46;&#46;&#46;';
...
add_filter( 'excerpt_more', 'boxstyle_excerpt_more' );


/*  Excerpt length
/* ------------------------------------ */
if ( ! function_exists( 'boxstyle_excerpt_length' ) ) {

	function boxstyle_excerpt_length( $length ) {
		if ( is_admin() ) {
			return $length;
		}
...
add_filter( 'excerpt_length', 'boxstyle_excerpt_length', 999 );


/*  Add responsive container to embeds
/* ------------------------------------ */	
if ( ! function_exists( 'boxstyle_embed_html' ) ) {

	function boxstyle_embed_html( $html, $url ) {
...
add_filter( 'embed_oembed_html', 'boxstyle_embed_html', 10, 3 );


/*  Add responsive container to jetpack embeds
/* ------------------------------------ */	
if ( ! function_exists( 'boxstyle_embed_html_jp' ) ) {

	function boxstyle_embed_html_jp( $html ) {
		return '<div class="video-container">' . $html . '</div>';
	}

}
add_filter( 'video_embed_html', 'boxstyle_embed_html_jp' );
...
if ( ! function_exists( 'boxstyle_admin_panel_css' ) ) {
	...
	function boxstyle_admin_panel_css() {
		global $pagenow;
...
add_action( 'admin_head', 'boxstyle_admin_panel_css' );


/*  TGM plugin activation
/* ------------------------------------ */
if ( ! function_exists( 'boxstyle_plugins' ) ) {
	
	function boxstyle_plugins() {	
		if ( get_theme_mod('recommended-plugins','on') =='on' ) { 	
			// Add the following plugins
			$plugins = array(
				array(
					'name' => esc_html__( 'Alx Extensions', 'boxstyle' ),
					'slug' => 'alx-extensions',
				),
				array(
					'name' => esc_html__( 'Meta Box', 'boxstyle' ),
					'slug' => 'meta-box',
				),
				array(
					'name' => esc_html__( 'Regenerate Thumbnails', 'boxstyle' ),
...
add_action( 'tgmpa_register', 'boxstyle_plugins' );


/*  WooCommerce basic support
/* ------------------------------------ */
function boxstyle_wc_wrapper_start() {
	echo '<div class="content">';
	echo '<div class="pad">';
}
function boxstyle_wc_wrapper_end() {
	echo '</div>';
	echo '</div>';
}
remove_action( 'woocommerce_before_main_content', 'woocommerce_output_content_wrapper', 10);
remove_action( 'woocommerce_after_main_content', 'woocommerce_output_content_wrapper_end', 10);
add_action('woocommerce_before_main_content', 'boxstyle_wc_wrapper_start', 10);
add_action('woocommerce_after_main_content', 'boxstyle_wc_wrapper_end', 10);
...
if ( ! function_exists( 'boxstyle_flexslider_gallery' ) ) {
	...
	function boxstyle_flexslider_gallery() {
